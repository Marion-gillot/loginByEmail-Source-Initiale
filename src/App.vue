...
const SUPABASE_URL = 'https://guptyybbsmdaidryptdv.supabase.co'
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd1cHR5eWJic21kYWlkcnlwdGR2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjMzMzc4MzEsImV4cCI6MTk3ODkxMzgzMX0.LFGpWG0arJSkV5S9dyDkpBwDAcX6f070QdT1lRA9Ltw'
  ...
  methods: {  
    ...
    async reset(){ 
      try { 
        ...
        if (error) throw error; 
        document.getElementById('status').innerHTML='You have a email for reset your password !' 
      } catch (error) { 
        alert(error.error_description || error.message); 
      } 
    },
